...
const DICT = {
  en: {
    ...
    'menu.none':'No menu today. Pick three and most customers will order from them.',
    'menu.set':'📋 Pick a menu',
    'menu.change':'📋 Change the menu',
    'menu.pickTitle':"Today's menu",
    'menu.pickSub':'Pick up to {n}. They sell for more, and most customers will ask for them.',
  ...
  nl: {
    ...
    'menu.none':'Nog geen menu. Kies er drie, dan bestellen de meeste klanten daaruit.',
    'menu.set':'📋 Menu kiezen',
    'menu.change':'📋 Menu aanpassen',
    'menu.pickTitle':'Menu van vandaag',
    'menu.pickSub':'Kies er maximaal {n}. Die brengen meer op en de meeste klanten vragen erom.',
